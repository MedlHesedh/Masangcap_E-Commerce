          ...
          <div key={s.id} className="card-premium group">
            <div className="aspect-[4/3] overflow-hidden relative">
              ...
              <div className="absolute top-4 right-4 md:top-6 md:right-6">
                <div className="bg-white/90 backdrop-blur-md px-3 py-1.5 md:px-4 md:py-2 rounded-lg md:rounded-xl shadow-xl text-primary font-black text-xs md:text-sm">
                  {s.price}
                </div>
              </div>
            </div>
            <div className="p-6 md:p-10">
              <span className="text-[10px] font-black text-primary uppercase tracking-widest mb-3 md:mb-4 block">{s.category}</span>
              <h3 className="text-xl md:text-2xl font-black mb-3 md:mb-4">{s.title}</h3>
              <p className="text-secondary/60 leading-relaxed font-medium mb-6 md:mb-8 text-sm md:text-base">{s.description}</p>
              <button className="w-full btn-secondary py-3 md:py-4">
                Add to Estimate
              </button>
            </div>
          </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
        {FINISHES.map((f) => (
          <div key={f.id} className="card-premium group">
            ...
            <div className="p-6 md:p-10">
              <span className="text-[10px] font-black text-primary uppercase tracking-widest mb-3 md:mb-4 block">{f.category}</span>
              <h3 className="text-xl md:text-2xl font-black mb-3 md:mb-4">{f.title}</h3>
              <p className="text-secondary/60 leading-relaxed font-medium mb-6 md:mb-8 text-sm md:text-base">{f.description}</p>
              <button className="w-full btn-secondary py-3 md:py-4">
                Select Style
              </button>
            </div>
